...
COPY bundle/1.1.2-v2.5.11.final/manifests /manifests/
COPY bundle/1.1.2-v2.5.11.final/metadata /metadata/
COPY bundle/1.1.2-v2.5.11.final/tests/scorecard /tests/scorecard/
